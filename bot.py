...
b = InlineKeyboardBuilder()
b.row(InlineKeyboardButton(text=“▶️ Начать тест”, callback_data=f”run*{q_id}”))
...
b = InlineKeyboardBuilder()
for s_id, ru, kk, *, _ in sections:
b.row(InlineKeyboardButton(text=f”🗑 {ru}”, callback_data=f”del_sec*{s_id}”))
...
# If action is numeric it means direct view: sec_ch*{s_id}
try:
if action.isdigit():
s_id = int(action)
lang = await get_user_lang(callback.from_user.id)
...
b = InlineKeyboardBuilder()
for s_id, ru, _, *, _ in sections:
b.row(InlineKeyboardButton(text=ru, callback_data=f”assign_sec*{s_id}”))
...
b = InlineKeyboardBuilder()
for s_id, ru, _, *, _ in sections:
b.row(InlineKeyboardButton(text=ru, callback_data=f”quiz_sec*{s_id}”))
b.row(InlineKeyboardButton(text=“🔙 Назад”, callback_data=“admin_panel”))
...
b.row(InlineKeyboardButton(text=label, callback_data=f”appacc*{q_id}_{atype}”))
